export default function page() {
  return (
      ...
      <section
        ...
        data-overlay-dark="6"
        data-background="img/file_000000006ff461f9a3eae14ea56fe705.png"
      >
        <div className="v-middle">
          <div className="container">
            <div className="row">
              <div className="col-md-12 text-center">
                <h6 style={{ color: "#f5b754" }}>Blog & Notícias</h6>
                <h1>JMC NEWS</h1>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-4 col-md-6 mb-45">
              <div className="item">
                <div className="img">
                  <img src="img/cars/JMC VIGUS 2021 01.jpg" alt="" />
                </div>
                <div className="wrapper">
                  <div className="date">
                    <a href="#">29 Dez, 2025</a>
                  </div>
                  <div className="con">
                    <div className="category">
                      ...
                      <a href="#">
                        <i className="ti-comment"></i>5 Comentários
                      </a>
                    </div>
                    <div className="text">
                      <a href="post.html">
                        Documentos necessários para alugar viaturas com a JMC
                        Angola
                      </a>
                    </div>
              ...
              <div className="item">
                ...
                <div className="wrapper">
                  ...
                  <div className="con">
                    ...
                    <div className="text">
                      <a href="post.html">
                        Custos de aluguer de carros desportivos e executivos
                      </a>
                    </div>
                    <a href="post.html" className="icon-btn">
                      <i className="ti-arrow-top-right"></i>
              ...
              <div className="item">
                ...
                <div className="wrapper">
                  ...
                  <div className="con">
                    ...
                    <div className="text">
                      <a href="post.html">
                        Como verificar multas de trânsito em viaturas alugadas
                      </a>
                    </div>
                    <a href="post.html" className="icon-btn">
                      <i className="ti-arrow-top-right"></i>
              ...
              <div className="item">
                ...
                <div className="wrapper">
                  ...
                  <div className="con">
                    ...
                    <div className="text">
                      <a href="post.html">
                        Como alugar um carro no aeroporto com a JMC
                      </a>
                    </div>
                    <a href="post.html" className="icon-btn">
                      <i className="ti-arrow-top-right"></i>
              ...
              <div className="item">
                ...
                <div className="wrapper">
                  ...
                  <div className="con">
                    ...
                    <div className="text">
                      <a href="post.html">
                        Multas por infrações ao usar viaturas alugadas pela JMC
                      </a>
                    </div>
                    <a href="post.html" className="icon-btn">
                      <i className="ti-arrow-top-right"></i>
              ...
              <div className="item">
                ...
                <div className="wrapper">
                  ...
                  <div className="con">
                    ...
                    <div className="text">
                      <a href="post.html">
                        Checklist: o que verificar antes de alugar um carro
                      </a>
                    </div>
                    <a href="post.html" className="icon-btn">
                      <i className="ti-arrow-top-right"></i>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 text-center">
              ...
              <p>
                Paragem da Mutamba, via expresse. Para mais informações online,
                visite nosso site.
              </p>
              <a
